...
@ConfigurePigeon(
  PigeonOptions(
    ...
    kotlinOut: 'android/src/main/kotlin/io/flutter/plugins/googlemobileads/mediation/gma_mediation_unity/UnityPrivacyApi.g.kt',
    kotlinOptions: KotlinOptions(
      package:
          "io.flutter.plugins.googlemobileads.mediation.gma_mediation_unity",
    ),
    swiftOut: 'ios/gma_mediation_unity/Sources/gma_mediation_unity/UnityPrivacyApi.g.swift',
