...
public class FlutterAdLoader {
    ...
    public void loadAppOpenAd(
            ...
            int openAdOrientation,
            @NonNull AppOpenAd.AppOpenAdLoadCallback loadCallback) {
        AppOpenAd.load(context, adUnitId, adRequest, openAdOrientation, loadCallback);
    }

  /**
   * Load an ad manager app open ad.
   */
  public void loadAdManagerAppOpenAd(
          @NonNull Context context,
          @NonNull String adUnitId,
